...
"[project]/apps/islek-app/app/api/tables/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const tables = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$kv$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTables"])('demo-tenant');
...
async function POST(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$kv$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setTables"])('demo-tenant', body);
        return Response.json({
            ok: true
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bx_gcl._.js.map