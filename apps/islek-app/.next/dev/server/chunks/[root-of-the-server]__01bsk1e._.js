...
"[project]/apps/islek-app/app/api/config/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const pricing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$kv$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPricing"])('demo-tenant');
...
async function POST(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$kv$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setPricing"])('demo-tenant', body);
        return Response.json({
            ok: true
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__01bsk1e._.js.map